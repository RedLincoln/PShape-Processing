...
void infoView(){
  ...
  textSize(25);
  text("Rotation", width / 2, 330);
  text("Translate", width / 2, 540);
  text("Hope it's helpfull!!!!", width / 2, 760);
  fill(foregroundColor);
  textSize(22);
  text(whatItDoesMessage, width / 2, 100);
  text(pauseMessage, width / 2, 230);
  text(dimensionMessage, width / 2, 260);
  text(clearMessage, width / 2, 290);
  text("W key to rotate UP", width / 2, 370);
  text("S key to rotate DOWN", width / 2, 410);
  text("A key to rotate LEFT", width / 2, 450);
  text("D key to rotate RIGHT", width / 2, 490);
  text("UP_ARROW key to translate UP", width / 2, 580);
  text("DOWN_ARROW key to translate DOWN", width / 2, 620);
  text("LEFT_ARROW key to translate LEFT", width / 2, 660);
  text("RIGHT_ARROW key to translate RIGHT", width / 2, 700);
  int gap = 5;
  int lineWidth = 10;
  int x = gap * 2;
  int y = 160;
